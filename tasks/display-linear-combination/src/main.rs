...
impl Display for Coefficient {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        ...
        write!(f, " {} {}e({})",
               if c < 0. { "-" } else { if f.alternate() { " " } else { "+" } },
               if c.abs() == 1. {
                   "".to_string()
               } else {
                   c.abs().to_string() + "*"
...
mod tests {
    ...
    #[test]
    fn test01() {
        assert_eq!("   e(1) + 2*e(2) + 3*e(3)", linear_combination(&vec![1., 2., 3.]))
    }

    #[test]
    fn test02() {
        assert_eq!("   e(2) + 2*e(3) + 3*e(4)", linear_combination(&vec![0., 1., 2., 3.]))
    }

    #[test]
    fn test03() {
        assert_eq!("   e(1) + 3*e(3) + 4*e(4)", linear_combination(&vec![1., 0., 3., 4.]))
    }
    ...
    #[test]
    fn test07() {
        assert_eq!("   e(1) + e(2) + e(3)", linear_combination(&vec![1., 1., 1.]))
    }
    ...
    #[test]
    fn test09() {
        assert_eq!(" - e(1) - 2*e(2) - 3*e(4)", linear_combination(&vec![-1., -2., 0., -3.]))
    }
