...
fn jaro (str1: &str, str2: &str) -> f64 {
    ...
    for i in 0_usize..str1_len {
        ...
        for k in start..end {
            ...
            if str1.chars().nth(i).unwrap() != str2.chars().nth(k).unwrap() { continue; }
    ...
    for i in 0_usize..str1_len {
        ...
        while !str2_matches[k] { k += 1; }
        // increment transpositions
        if str1.chars().nth(i).unwrap() != str2.chars().nth(k).unwrap() { transpositions += 1.0; }
        k += 1;
    }
