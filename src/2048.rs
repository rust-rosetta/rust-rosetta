...
mod mod2048 {
    ...
    fn draw_grid(&self, grid: [[Tile; 4]; 4], rows: usize, cols: usize) {
      ...
      let height = 18;
    	...
    	for i in 0..rows {
          ...
          self.draw_rectangle(x_coord, y_coord, cell_width, cell_height,
            Color::Black, Color::White, Color::Black);
          if num != "0" {
            self.rustbox.print(x_coord + x_text_offset, y_coord + y_text_offset,
              rustbox::RB_NORMAL, Color::White, Color::Black, &num);
    		  }
        }
    	}
    }
  ...
  impl<'a> TermboxUI<'a> {
    ...
    fn draw_rectangle(&self, x: usize, y: usize, w: usize, h: usize,
       fill: Color, fg: Color, bg: Color) {
